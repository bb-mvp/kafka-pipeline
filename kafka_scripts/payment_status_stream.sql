...
CREATE OR REPLACE STREAM "transactions"
  ...
  AS SELECT P.BFO_TRANSACTION_ID AS TRANSACTION_ID, P.CORRELATION_ID as CORRELATION_ID, P.SOURCE_ACCOUNT AS SOURCE_ACCOUNT, P.TARGET_ACCOUNT AS DESTINATION_ACCOUNT, P.TRANSACTION_AMOUNT AS AMOUNT, 
  P.TRANSACTION_CURRENCY AS TRANSACTION_CURRENCY, P.TRANSACTION_DESCRIPTION AS DESCRIPTION, P.TRANSACTION_VALUEDATE AS BOOKING_DATE, T.ERROR_CODE AS STATUS FROM "mc_status" T INNER JOIN "mc_payments" P
